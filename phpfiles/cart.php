        ...
        <div id="cart">
            <table id="cart-display">
                <tr>
                    ...
                    <th style="padding:15px;">Plant Name</th>
                ...
                <?php 
                    ...
                    for($i = 0; $i < $count; $i++){
                        ...
                        $end =$result;
                        setcookie('total', $end);
                        setcookie('quantity', $count);
                        
                        if($i%3 == 0){
                        print '<tr>';
                        }
                        print '<td style="border:1px solid black; padding:15px;"><img width="100px;" src="'.$split_items[0].'"></td>';
                        print '<td style="border:1px solid black; padding:15px;">'.$split_items[1].'</td>';
                        print '<td style="border:1px solid black; padding:15px;"> $ '.$split_items[2].'</td>';
                        //print '<td style="border:1px solid black; padding:5px;">'.$split_line[$i].'</td>';
                ...
                <?php
                    print '<tr>';
                    print '<td style="border:1px solid black; padding:15px;">Total Items:</td>';
                    print '<td style="border:1px solid black; padding:15px;">'.$count.'</td>';
                    print '<td style="border:1px solid black; padding:15px;"> $ '.$end.'</td>';
                    print '</tr>';
                
                //if delete form is pressed, delete the cart  
                ?>
            </table>
            <br>
            <form action="checkout.php" method="POST">
                <input type="submit" class="submission" value="checkout">
              </form>
            <form action="#" method="POST">
                <input type="submit" class="submission" action="" name="deleteAll" value="Delete Cart" id="del">
            </form>
