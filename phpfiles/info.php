...
--> 
    ...
    <body>
        ...
        <div id="content">
            <div class="textbox">
            <h2>About Plant Market</h2>
            <p>Plant Market is an E-Commerce simulation designed to model the plant-purchasing experience. 
                For educational purposes only. Not intended for commercial use. No payment is processed on this site, and no user data is used.
            </p>
            </div>
        </div>
        <script>
