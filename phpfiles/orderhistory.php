    ...
    <body>
        ...
        <div id="cart">
            ...
            <table id="cart-display">
                ...
                <?php 
                    $data = file_get_contents($file_path . "/".$_COOKIE['firstname'].".txt");
                    $split_line = explode("\n", $data);
                    $count = count($split_line);
                    ...
                    for($i = 0; $i < $count - 1; $i++){
                        ...
                        print '<td style="border:1px solid black; padding:15px;">'.$_COOKIE['firstname'].'</td>';
                        print '<td style="border:1px solid black; padding:15px;">'.$split_items[0].'</td>';
            ...
            ?>
                    <div class="textbox">
                    <p>Please log in before viewing your order history!</p>
  ...
  //          }
          ...
          function mobileNav(x) {
              if (x.matches) { // If media query matches
                  ...
                  for(let i = 0; i < navLinks.length; i++){
                      navLinks[3].classList.remove('hide')
